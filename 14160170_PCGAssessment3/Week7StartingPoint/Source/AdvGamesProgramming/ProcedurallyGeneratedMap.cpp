...
void AProcedurallyGeneratedMap::SetMapPosition(FVector SpawnPosition) {
	SetActorLocationAndRotation(SpawnPosition, FRotator(0.0f, 0.0f, 0.0f), false, 0, ETeleportType::None);
	GenerateMap();
}

void AProcedurallyGeneratedMap::GenerateMap()
{
	float PerlinOffset = FMath::RandRange(-100.0f, 100.0f);
